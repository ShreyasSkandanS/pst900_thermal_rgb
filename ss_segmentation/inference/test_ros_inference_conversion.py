...
def main():
    ...
    for step, (images) in enumerate(loader):
        ...
        # Testing PIL to ROS conversion
        #label_o = ToPILImage()(label_color)
        #label_o = label_o.convert('L')
        #label_o = PIL.ImageOps.autocontrast(label_o)
        #pdb.set_trace()
