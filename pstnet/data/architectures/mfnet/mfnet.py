...
def unit_test():
    import numpy as np
    x = torch.tensor(np.random.rand(2,4,360,640).astype(np.float32))
    model = Net(4,n_class=9)
    y = model(x)
    print('output shape:', y.shape)
    assert y.shape == (2,9,360,640), 'output shape (2,9,480,640) is expected!'
    print('test ok!')
